...
__Raw data for the analysis.__ Each of the 16 variables is given in a column, each state is in a row. See [Details](https://cci-dev.org/shiny/closed/states/#section-details) for a table of how each variable was scored.
